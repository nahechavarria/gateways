exports = {
	...
	AGUADA: process.env.AGUADA_ADDRESS,
	CALIMETE: process.env.CALIMETE_ADDRESS,
	MK_USER: process.env.MK_USER,
	MK_PASS: process.env.MK_PASS,
	CONN_PORT: process.env.CONN_PORT,
};
